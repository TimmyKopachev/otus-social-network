...
public class JwtRequestFilter extends OncePerRequestFilter {
    ...
    @Autowired
    @Lazy
    private SnDaoAuthenticationProvider authenticationProvider;
        ...
        if (StringUtils.hasText(token)) {
            ...
            if (username != null && jwtTokenProcessor.isValidToken(token)
                ...
                if (jwtTokenProcessor.isValidToken(accessToken.getAccessToken(), authenticatedPersonDetails)) {
                    ...
                    var authentication = authenticationProvider.authenticate(upaToken);
                    ((AuthenticatedPersonDetails) authentication.getPrincipal()).setAuthenticationTokens(
